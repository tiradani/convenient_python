...
# Origin:  https://github.com/ProteinSimple/python-fstab
#
#
# Modified to include additional properties and fix pylint complaints
...
"""
    ...
    def get_device(self):
        if self.dict["device"]:
            return str(self.dict["device"])
        else:
            return None

    def set_device(self, value):
        self.dict["device"] = str(value)

    device = property(get_device, set_device)

    def get_fstype(self):
        if self.dict["fstype"]:
            return str(self.dict["fstype"])
        else:
            return None

    def set_fstype(self, value):
        self.dict["fstype"] = str(value)

    fstype = property(get_fstype, set_fstype)

    def get_directory(self):
        if self.dict["directory"]:
            return str(self.dict["directory"])
        else:
            return None

    def set_directory(self, value):
        self.dict["directory"] = str(value)
    ...
    def get_options(self):
        if self.dict["options"]:
            return self.dict["options"].split(",")
        else:
            return None

    def set_options(self, options_list):
        self.dict["options"] = ",".join(options_list)
